namespace ADOSample {
	partial class Form1 {
		...
		private void InitializeComponent() {
			...
			this.infosys202028DataSet = new ADOSample.infosys202028DataSet();
			this.memoTableBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.memoTableTableAdapter = new ADOSample.infosys202028DataSetTableAdapters.memoTableTableAdapter();
			this.tableAdapterManager = new ADOSample.infosys202028DataSetTableAdapters.TableAdapterManager();
			...
			((System.ComponentModel.ISupportInitialize)(this.infosys202028DataSet)).BeginInit();
			...
			this.SuspendLayout();
			// 
			// infosys202028DataSet
			// 
			this.infosys202028DataSet.DataSetName = "infosys202028DataSet";
			this.infosys202028DataSet.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			// memoTableBindingSource
			// 
			this.memoTableBindingSource.DataMember = "memoTable";
			this.memoTableBindingSource.DataSource = this.infosys202028DataSet;
			// 
			...
			this.tableAdapterManager.UpdateOrder = ADOSample.infosys202028DataSetTableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
			// 
			...
			this.memoTableBindingNavigator.Size = new System.Drawing.Size(705, 25);
			...
			// 
			this.memoTableDataGridView.AllowUserToAddRows = false;
			...
			this.memoTableDataGridView.Location = new System.Drawing.Point(12, 28);
			this.memoTableDataGridView.Name = "memoTableDataGridView";
			this.memoTableDataGridView.RowTemplate.Height = 21;
			this.memoTableDataGridView.Size = new System.Drawing.Size(681, 201);
			...
			idLabel.Location = new System.Drawing.Point(12, 299);
			...
			this.idTextBox.Location = new System.Drawing.Point(59, 296);
			...
			dateLabel.Location = new System.Drawing.Point(12, 325);
			...
			this.dateDateTimePicker.Location = new System.Drawing.Point(59, 321);
			...
			aythorLabel.Location = new System.Drawing.Point(12, 349);
			...
			this.aythorTextBox.Location = new System.Drawing.Point(59, 346);
			...
			memoLabel.Location = new System.Drawing.Point(12, 374);
			...
			this.memoTextBox.Location = new System.Drawing.Point(59, 371);
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(59, 429);
			...
			((System.ComponentModel.ISupportInitialize)(this.infosys202028DataSet)).EndInit();
		...
		private infosys202028DataSet infosys202028DataSet;
		private System.Windows.Forms.BindingSource memoTableBindingSource;
		private infosys202028DataSetTableAdapters.memoTableTableAdapter memoTableTableAdapter;
		private infosys202028DataSetTableAdapters.TableAdapterManager tableAdapterManager;
